...
end module zawier_funckje_search

program prog43
    use zawier_funckje_search
    implicit none
    ...
    write(unit=*,fmt=*) data_array(ans(1)-1)
    write(unit=*,fmt=*)data_array(ans(2)-1)
    stop
end program prog43